...
const CampaignAddModal = ({ isShow, closeHandler, tab, setAddStatus }) => {
  ...
  const apiBasedOnTab = () => {
    switch (tab) {
      case "home":
        return `${API_BASE_URL}/banners/addbanner`;
      case "desktop":
        return `${API_BASE_URL}/desktop-banners/addbanner`;
      case "mobile":
        return `${API_BASE_URL}/mobile-banners/addbanner`;
      default:
        return "";
    }
  };
