...
function AddAwardsModal({ isShow, closeHandler }) {
    ...
    const fetchAwards = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/users/${userId}/awards`);
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`${API_BASE_URL}/users/${userId}/awards/${deleteIndex}`);
            const newAwards = [...awards];
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await axios.post(
                `${API_BASE_URL}/users/upload-awards/${userId}`,
                formData,
