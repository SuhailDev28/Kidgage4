...
const DashboardPage = () => {
  ...
  const coursesInitialDataHandler = async () => {
    try {
      const res = await axios.get(
        `${API_BASE_URL}/courses/get-all-courses`
      );
  ...
  const leadsGeneratedinitialDataHandler = async () => {
    try {
      const res = await axios.get(`${API_BASE_URL}/customers/bookings`);
  ...
  const upcommingMeetingsInitialDataHandler = async () => {
    try {
      const response = await axios.get(
        `${API_BASE_URL}/users/meeting-scheduled-users`
      );
